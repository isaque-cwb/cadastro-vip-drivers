...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	private void createDialogForm(Department obj, String absoluteName, Stage parenteStage) {
		try {
			...
			dialogStage.setTitle("Cadastre Novo Parceiro(a)");
	...
	private void removeEntity(Department obj) {
		Optional<ButtonType> result = Alerts.showConfirmation("TEM CERTEZA!", "Vc quer mesmo DELETAR Parceiro?");
		
		if (result.get() == ButtonType.OK) {
			if (service == null) {
				throw new IllegalStateException("Cadastro estava Vazio");
			}
			try {
				service.remove(obj);
				updateTableView();
